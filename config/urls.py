...
urlpatterns = [path('', views.home), path('login/', views.sign_in), path('register/', views.register),
               ...
               path('api/thrown-preview/', views.thrown_preview), path('api/sequence-preview/', views.sequence_preview), path('api/action/', views.action), path('api/photo/<int:pk>/', views.photo),
